...
<svg
	...
	fill={color}
	class={$$props.class}
	><title>ionicons-v5-k</title><rect x="336" y="336" width="80" height="80" rx="8" ry="8" /><rect
		x="272"
		y="272"
		width="64"
		height="64"
	...
	/><rect x="416" y="416" width="64" height="64" rx="8" ry="8" /><rect
		...
		rx="8"
		ry="8"
	/><rect x="272" y="432" width="48" height="48" rx="8" ry="8" /><path
	...
	/><path
		d="M208,32H64A32,32,0,0,0,32,64V208a32,32,0,0,0,32,32H208a32,32,0,0,0,32-32V64A32,32,0,0,0,208,32ZM176,168a8,8,0,0,1-8,8H104a8,8,0,0,1-8-8V104a8,8,0,0,1,8-8h64a8,8,0,0,1,8,8Z"
	/><path
