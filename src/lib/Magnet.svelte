...
<svg
	...
	fill={color}
	class={$$props.class}
	><title>ionicons-v5-o</title><line
		x1="191.98"
		y1="463.79"
		x2="191.98"
		y2="415.79"
	...
	/><path
		d="M131.8,176.55l-31.11,31.12a16,16,0,0,0,0,22.62l45.25,45.26a16,16,0,0,0,22.63,0l31.11-31.11a4,4,0,0,0,0-5.66l-62.22-62.23A4,4,0,0,0,131.8,176.55Z"
	/><path
